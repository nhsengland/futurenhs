...
export const getSiteUsersByTerm = async ({
    ...
    term,
    pagination
}: Options, dependencies?: Dependencies): Promise<ServicePaginatedResponse<Array<Option>>> => {
    ...
    if(!ok){
        ...
        throw new ServiceError('An unexpected error occurred when attempting to get the matching site users', {
