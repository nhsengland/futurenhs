...
import GroupUpdateFolderPage, {
    Props,
} from '@pages/groups/[groupId]/folders/[folderId]/update/index.page'
...
describe('Group folder create/update template', () => {
    ...
    it('renders correctly', () => {
        render(<GroupUpdateFolderPage {...props} />)
    ...
    it('conditionally renders folder name when passed folder prop', () => {
        ...
        render(<GroupUpdateFolderPage {...propsCopy} />)
