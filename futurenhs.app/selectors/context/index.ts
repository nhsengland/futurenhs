...
import { getServerSideFormData, ServerSideFormData, getServerSideMultiPartFormData } from '@helpers/util/form';
...
export const selectFormData = (context: GetServerSidePropsContext): ServerSideFormData => context.req?.body && Object.keys(context.req.body).length > 0 ? getServerSideFormData(context.req.body) : null;
export const selectMultiPartFormData = (context: GetServerSidePropsContext): any => context.req?.body && Object.keys(context.req.body).length > 0 ? getServerSideMultiPartFormData(context.req.body) : null;
