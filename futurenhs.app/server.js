...
const generateCSP = (nonce) => {
    ...
    const csp = {
        ...
        'connect-src': `'self' https://dc.services.visualstudio.com *.google-analytics.com *.hotjar.com https://ws2.hotjar.com wss://ws2.hotjar.com/api/v2/client/ws wss://ws15.hotjar.com/api/v2/client/ws *.googletagmanager.com https://assets.nhs.uk https://cdn.eu.pendo.io https://data.eu.pendo.io`,
        'worker-src': `'self'`,
    }
