...
export default {
    ...
    bodyHtml: `
        ...
        <p>Users should report inappropriate content to the FutureNHS administration team upon discovery. Details on how to report inappropriate information can be found on our <a target="_blank" href="/contact-us">contact page</a>. We may remove any content which, in our opinion, does not comply with the FutureNHS policies or any applicable law or regulation and access privileges will be revoked.</p>
        <p>All content on this FutureNHS is classified as OFFICIAL, will be subject to Freedom of Information (FOI) requests and will be made available should an FOI request warrant this. OFFICIAL-SENSITIVE Content must not be uploaded to FutureNHS without prior authorisation from the platform administrators. Please <a target="_blank" href="/contact-us">contact us</a> to if you plan on sharing sensitive content.</p>
        ...
        <p>If in doubt, contact the content owner or <a target="_blank" href="/contact-us">contact us</a> to ask about permission.</p>
        ...
        <p><a target="_blank" href="/contact-us">Contact us</a> to ask for content to be removed. You’ll need to send us the web address (URL) of the content and explain why you think it should be removed. We’ll reply to let you know whether we’ll remove it.</p>
