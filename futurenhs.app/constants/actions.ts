export const enum actions {
    ...
    SITE_ADMIN_DOMAINS_ADD = 'https://schema.collaborate.future.nhs.uk/domains/v1/add',
    SITE_ADMIN_DOMAINS_DELETE = 'https://schema.collaborate.future.nhs.uk/domains/v1/delete',
    ...
    GROUPS_DISCUSSIONS_VIEW = 'https://schema.collaborate.future.nhs.uk/groups/v1/discussions/view',
    GROUPS_COMMENTS_ADD = 'https://schema.collaborate.future.nhs.uk/groups/v1/discussions/comments/add',
    GROUPS_COMMENTS_VIEW = 'https://schema.collaborate.future.nhs.uk/groups/v1/discussions/comments/view',
    ...
    GROUPS_MEMBERS_INVITE = 'https://schema.collaborate.future.nhs.uk/groups/v1/members/invite',
}
