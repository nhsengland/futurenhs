    ...
    const rowList = useMemo(
        () =>
            dynamicGroupsList?.map(
                ({ text, groupId, totalDiscussionCount, totalMemberCount }) => {
                    ...
                    const generatedCellClasses = {
                        ...
                        members: classNames({
                            ['u-justify-between u-w-full tablet:u-w-1/4 tablet:u-text-center']:
                                true,
                        }),
                        owner: classNames({
                    ...
                    const rows = [
                        ...
                        },
                        {
                            children: (
                                <Link href={`/groups/${groupId}/members`}>
                                    <a
                                        aria-label={`Go to ${mainHeading} members list`}
                                    >
                                        {totalMemberCount}
                                    </a>
                                </Link>
                        ...
                        {
                            children: (
                                <Link href={`/groups/${groupId}/update`}>
                                    <a aria-label={`Edit group ${mainHeading}`}>
                                        <SVGIcon
                                            name="icon-edit"
