                ...
                {hasMenuItems &&
                    <Accordion
                        ...
                        toggleOpenChildren={
                            <>
                                {activeMenuItemText}
                                <SVGIcon name={iconNames.CHEVRON_UP} className={generatedClasses.navTriggerIcon} />
                            </>
                        }
                        toggleClosedChildren={
                            <>
                                {activeMenuItemText}
                                <SVGIcon name={iconNames.CHEVRON_DOWN} className={generatedClasses.navTriggerIcon} />
                            </>
                        }
