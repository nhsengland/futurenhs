                ...
                <ul className="u-list-none u-p-0">
                    <li>
                        <div className={generatedClasses.block}>
                            <header className={generatedClasses.blockHeader}>Text block</header>
                            <div className={generatedClasses.blockBody}>
                                <h3 className="nhsuk-heading-l">Example text block title here</h3>
                                <p>Here’s an example of a text block and how it will look on the platform. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                            </div>
                        </div>
                    </li>
                </ul>
