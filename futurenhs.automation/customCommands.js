{
    ...
    let obj = {
        "core": `wdio wdio.headless.conf.js --suite=smokeTest --cucumberOpts.tagExpression="@Core and not @Pending"`,
        "pipeline": "wdio wdio.headless.conf.js --suite=fullRegression",
        "local": "wdio wdio.headless.conf.js --baseUrl=http://localhost:5000/ --suite=fullRegression",
        "devTest": `wdio wdio.headless.conf.js --baseUrl=https://futurenhs.cds.co.uk/ --suite=fullRegression`,
