...
Examples:
    ...
    | VbNC63Shkzeyyp81jSxtQvrBf0kAFMiSt9LGe8ncL5v61wnVxPE2FIgIl36lIynd7BlCJA6DvgcH02zgLGtLySYghOahZGcyKGATqafAazK8uPph70gwk8sGEjL7XCTFy9POKDkRoFHM2nSTxipNe6vMNPcYGeD2uEC3cBqVkS2i39NYOkzPSP4F5nWhqQFnhZwZmw6ED | description | Enter 200 or fewer characters |
...
Scenario Outline: FNHS69 - Update folder error validation
    ...
    And I click the 'Save and continue' button
    Then the '<errorMsg>' summary is displayed
Examples: 
