BEGIN TRANSACTION
	...
	INSERT INTO @entityTable ([Id]) VALUES ((SELECT Entity_Id FROM Comment WHERE Content ='<p>First Comment</p>' AND Parent_EntityId = '83702899-fdbf-49ed-bb1d-adda00f757c3'))
	INSERT INTO @entityTable ([Id]) VALUES ((SELECT Entity_Id FROM Comment WHERE Content ='<p>Third Comment</p>' AND Parent_EntityId = '83702899-fdbf-49ed-bb1d-adda00f757c3'))
	INSERT INTO @entityTable ([Id]) VALUES ((SELECT Entity_Id FROM Comment WHERE Content ='<p>Fourth Comment</p>' AND Parent_EntityId = '83702899-fdbf-49ed-bb1d-adda00f757c3'))
	INSERT INTO @entityTable ([Id]) VALUES ((SELECT Entity_Id FROM Comment WHERE Content ='<p>Fifth Comment</p>' AND Parent_EntityId = '83702899-fdbf-49ed-bb1d-adda00f757c3'))
	INSERT INTO @entityTable ([Id]) VALUES ((SELECT Entity_Id FROM Comment WHERE Content ='<p>Sixth Comment</p>' AND Parent_EntityId = '83702899-fdbf-49ed-bb1d-adda00f757c3'))
	INSERT INTO @entityTable ([Id]) VALUES ((SELECT Entity_Id FROM Comment WHERE Content ='<p>Seventh Comment</p>' AND Parent_EntityId = '83702899-fdbf-49ed-bb1d-adda00f757c3'))
	INSERT INTO @entityTable ([Id]) VALUES ((SELECT Entity_Id FROM Comment WHERE Content ='<p>Eighth Comment</p>' AND Parent_EntityId = '83702899-fdbf-49ed-bb1d-adda00f757c3'))
	INSERT INTO @entityTable ([Id]) VALUES ((SELECT Entity_Id FROM Comment WHERE Content ='<p>Ninth Comment</p>' AND Parent_EntityId = '83702899-fdbf-49ed-bb1d-adda00f757c3'))
	INSERT INTO @entityTable ([Id]) VALUES ((SELECT Entity_Id FROM Comment WHERE Content ='<p>Tenth Comment</p>' AND Parent_EntityId = '83702899-fdbf-49ed-bb1d-adda00f757c3'))
	INSERT INTO @entityTable ([Id]) VALUES ((SELECT Entity_Id FROM Comment WHERE Content ='<p>Eleventh Comment</p>' AND Parent_EntityId = '83702899-fdbf-49ed-bb1d-adda00f757c3'))
	INSERT INTO @entityTable ([Id]) VALUES (N'ca5c5162-7a2a-482e-b15b-ad7f010e30cf'), (N'edcc5437-b704-45d8-8972-ad7f010e2316'), (N'e56abf3c-7aa0-465a-a146-ad7f010e4acc'), (N'bcca8784-0e5e-496c-9bbb-ad7f010e51b4'), (N'e846a7bc-327a-4c05-89c7-ad7f010e5ed2'), (N'e4940ced-087d-41e9-a350-ad7f010e6bc9'), (N'69f7c324-3c63-4917-8b22-ad7f010e719e'), (N'58ab24e5-f3f9-4f8d-aba9-ad7f010e809d'), (N'107d1f85-3366-410c-8ffe-ad7f010e8586'), (N'0e807603-6d32-4f4f-833b-ad7f010e903a'), (N'e28ed14b-46ae-4fdd-8988-ad7f010e959c'), (N'80d3fc63-4852-4163-98ac-ad880118903c'), 
    ...
    INSERT INTO @entityTable ([id]) SELECT Entity_Id FROM [dbo].[Comment] WHERE CreatedBy = @autoUser;
