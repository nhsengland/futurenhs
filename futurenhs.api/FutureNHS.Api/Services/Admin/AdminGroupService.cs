...
namespace FutureNHS.Api.Services.Admin
{
    public sealed class AdminGroupService : IAdminGroupService
    {
        ...
        public AdminGroupService(ISystemClock systemClock,
            ...
            IHtmlSanitizer htmlSanitizer, IContentService contentService)
        {
        ...
        public async Task CreateGroupAsync(Guid userId, Stream requestBody, string? contentType, CancellationToken cancellationToken)
        {
            ...
            var createContentResponse = await _contentService.CreateContentAsync(userId, groupSiteDto.GroupId, null, cancellationToken);
            ...
            if (!createContentResponse.Succeeded)
            {
                ...
                _logger.LogError($"Error: CreateContentAsync - Error creating group homepage content {groupSiteDto.GroupId}");
                throw new HttpRequestException($"Error: CreateContentAsync - Error creating group homepage content {groupSiteDto.GroupId}");
            }
