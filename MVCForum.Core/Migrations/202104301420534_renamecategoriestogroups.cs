namespace MvcForum.Core.Services.Migrations
{
    ...
    public partial class renamecategoriestogroups : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        FacebookAccessToken = c.String(maxLength: 1000),
                        FacebookId = c.Long(),
                        TwitterAccessToken = c.String(maxLength: 1000),
                        TwitterId = c.String(maxLength: 150),
                        GoogleAccessToken = c.String(maxLength: 1000),
                        GoogleId = c.String(maxLength: 150),
                        MicrosoftAccessToken = c.String(maxLength: 1000),
            ...
            CreateTable(
                ...
                .Index(t => t.Slug, unique: true, name: "IX_Group_Slug")
                .Index(t => t.Group_Id)
                .Index(t => t.Section_Id);
            
            CreateTable(
                "dbo.GroupNotification",
                c => new
                    {
                        Id = c.Guid(nullable: false),
                        Group_Id = c.Guid(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.GroupNotification", "MembershipUser_Id", "dbo.MembershipUser");
            ...
            DropForeignKey("dbo.Topic", "Group_Id", "dbo.Group");
            DropForeignKey("dbo.Group", "Section_Id", "dbo.Section");
            DropForeignKey("dbo.Group", "Group_Id", "dbo.Group");
            DropForeignKey("dbo.GroupPermissionForRole", "Permission_Id", "dbo.Permission");
            DropForeignKey("dbo.GroupPermissionForRole", "MembershipRole_Id", "dbo.MembershipRole");
            ...
            DropForeignKey("dbo.GroupPermissionForRole", "Group_Id", "dbo.Group");
            DropForeignKey("dbo.GroupNotification", "Group_Id", "dbo.Group");
            ...
            DropIndex("dbo.GroupPermissionForRole", new[] { "Permission_Id" });
            DropIndex("dbo.GroupPermissionForRole", new[] { "MembershipRole_Id" });
            DropIndex("dbo.GroupPermissionForRole", new[] { "Group_Id" });
            DropIndex("dbo.GroupNotification", new[] { "MembershipUser_Id" });
            DropIndex("dbo.GroupNotification", new[] { "Group_Id" });
            DropIndex("dbo.Group", new[] { "Section_Id" });
            DropIndex("dbo.Group", new[] { "Group_Id" });
            DropIndex("dbo.Group", "IX_Group_Slug");
            DropIndex("dbo.Topic", new[] { "MembershipUser_Id" });
            DropIndex("dbo.Topic", new[] { "Poll_Id" });
            DropIndex("dbo.Topic", new[] { "Post_Id" });
            DropIndex("dbo.Topic", new[] { "Group_Id" });
            ...
            DropTable("dbo.GroupPermissionForRole");
            DropTable("dbo.GroupNotification");
            DropTable("dbo.Group");
            DropTable("dbo.Topic");
